...
def trainSentiment(stockCode):
    ...
    plt.legend()
    plt.savefig('/Users/yidan/Downloads/BullStockKing4.0/BullStockKing4.2/static/predict'+stockCode+'.png')
...
def hisData():
    ...
    result0 = cipin(details.stockNews)
